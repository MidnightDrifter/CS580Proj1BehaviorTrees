...
INT WINAPI WinMain( HINSTANCE, HINSTANCE, LPSTR, int )
{
  ...
  RegisterClassEx(&wc);
  HWND hwnd = CreateWindow(_T("ImGui Example"), _T("Summer 2016 CS380/CS580 Project 1: Behavior Trees"), WS_OVERLAPPEDWINDOW, 100, 100, 1024, 768, NULL, NULL, wc.hInstance, NULL);
  if (hwnd == NULL)
  {
